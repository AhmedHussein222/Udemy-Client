...
function Welcomehome() {
  ...
  const settings = {
    ...
    slidesToScroll: 1,
    prevArrow: (
      <div style={{ display: "block", color: "black", fontSize: "1rem" }}>
        ‹
      </div>
    ),
    nextArrow: (
    ...
    <Box>
      <Box
        sx={{
          position: "relative",
          backgroundImage:
            "url(https://s.udemycdn.com/teaching/billboard-desktop-2x-v4.jpg)",
      ...
      <Box>
        ...
        >
          ...
          >
            ...
            <Typography variant="body2">
              Teach what you love and help learners gain new skills, advance
              their careers, and explore new hobbies.
            </Typography>
          </Box>
          ...
          <TabContext value={value}>
              ...
              >
                <Box sx={{ textAlign: { xs: "center", md: "left" }, flex: 1 }}>
                  <Typography gutterBottom variant="body1">
                    ...
                    <br /> Then choose a promising topic with the help of our
                    <br /> Marketplace Insights tool.
                  </Typography>
                  <Typography gutterBottom variant="body1">
                  ...
                  <Typography gutterBottom variant="body1">
                    We offer plenty of resources on how <br />
                    to create your first course. And, our instructor
                    <br /> dashboard and curriculum pages help keep you
                    organized.
                  </Typography>
                </Box>
              ...
              >
                <Box sx={{ textAlign: { xs: "center", md: "left" }, flex: 1 }}>
                  <Typography gutterBottom variant="body1">
                    ...
                    <br /> by promoting your course through social media and
                    your <br />
                    professional networks.
                  </Typography>
                  <Typography gutterBottom variant="body1">
                    Your course will be discoverable in our <br />
                    marketplace where you earn revenue from
                    <br /> each paid enrollment.
                  </Typography>
                  ...
                  <Typography gutterBottom variant="body1">
                    ...
                    <br /> incentives while our global promotions drive traffic{" "}
                    <br />
                    to courses. There’s even more opportunity for courses <br />
            ...
            <TabPanel value="3">
              ...
              >
                <Box sx={{ textAlign: { xs: "center", md: "left" }, flex: 1 }}>
                  <Typography gutterBottom variant="body1">
                    Use basic tools like a smartphone or a DSLR
                    <br /> camera. Add a good microphone and you’re ready <br />
                    to start.
                  </Typography>
                  <Typography gutterBottom variant="body1">
                    If you don’t like being on camera,
                    <br /> just capture your screen. Either way,
                    <br /> we recommend two hours or more of video <br />
                    for a paid course.
                  </Typography>
                  <Typography fontWeight="bold" gutterBottom variant="h5">
                    How we help you
                  ...
                  <Typography gutterBottom variant="body1">
                    ...
                    <br /> throughout the process and provide feedback
                    <br /> on test videos.
                  </Typography>
                </Box>
      ...
      >
        <Box sx={{ backgroundColor: "#f5f5f5", my: 5, px: { xs: 2, sm: 5 } }}>
          ...
          >
            ...
            <Typography
              variant="body1"
              sx={{ textAlign: { xs: "center", sm: "left" }, maxWidth: "90%" }}
            >
              “I’m proud to wake up knowing my work is helping people
              <br /> around the world improve their careers and build great
              things.
              <br /> While being a full-time instructor is hard work,
              <br /> it lets you work when, where, and how you want.”
              <br />
        ...
        <Box sx={{ backgroundColor: "#f5f5f5", px: { xs: 2, sm: 5 } }}>
          ...
          >
            ...
            <Typography
              ...
              sx={{ textAlign: { xs: "center", sm: "left" }, maxWidth: "90%" }}
            >
              “Udemy has changed my life. It’s allowed me to follow
              <br /> my passion and become a teacher I love to see my students
              succeed
              <br /> and hear them say they’ve learned more, quicker,
              <br />
        ...
        <Box sx={{ backgroundColor: "#f5f5f5", px: { xs: 2, sm: 5 } }}>
          ...
          >
            ...
            <Typography
              ...
              sx={{ textAlign: { xs: "center", sm: "left" }, maxWidth: "90%" }}
            >
              “Teaching on Udemy has provided me with two important elements:
              <br /> the opportunity to reach more learners than I<br />
              ever would be able to on my own and a steady stream of extra
              income.”
              <br />
      ...
      >
        ...
        <Box sx={{ textAlign: "center" }}>
          ...
          <Typography variant="body1">You won’t have to do it alone</Typography>
          <br />

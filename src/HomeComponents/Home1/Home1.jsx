		...
		<div className="home-container">
			...
			<Slider {...settings}>
				<div className="slide-wrapper">
					<img src={slide1} alt={t("Slide 1")} className="slide-image" />
					<div className="slide-content">
						<h2 className="slide-title">
							{t("Skills that drive you forward")}
						</h2>
						...
						<div className="buttons">
							<button className="btn-purple">
								{t("Plan for individuals")}
							</button>
							<button className="btn-outline">
								{t("Plan for organizations")}
							</button>
						</div>
					</div>
				</div>{" "}
				<div className="slide-wrapper">
					...
					<div className="slide-content left">
						<h2 className="slide-title">{t("Learning that gets you")}</h2>
						<p className="slide-text">
							{t("Skills for your present (and your future)")}.{" "}
							{t("Get started with us")}.
						</p>
					</div>
				</div>{" "}
				<div className="slide-wrapper">
			...
			<div className="below-slider-text">
				<h1>{t("Ready to reimagine your career")}</h1>
				<p>
					{t(
						...
						<Card sx={{ borderRadius: 4, width: 400 }}>
							...
							<CardContent sx={{ textAlign: "left" }}>
								...
								<Typography variant="body2" color="text.secondary" mb={2}>
									{t("$127,005 average salary (US) | 16,500 open roles (US)")}
								</Typography>
